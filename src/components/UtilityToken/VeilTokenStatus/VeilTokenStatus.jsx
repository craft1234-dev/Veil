...
export default function VeilTokenStatus() {
  return (
          ...
          <div className="card">
            ...
            <div className="p-3 p-lg-4 card-body">
              <div className="mb-0 d-flex flex-row align-items-center justify-content-center gap-2 text-primary card-title h5">
                ...
                <p className="h1 text-primary mb-0 text-center">5,687</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="card">
            ...
            <div className="p-3 p-lg-4 card-body">
              <div className="mb-0 d-flex flex-row align-items-center justify-content-center gap-2 text-primary card-title h5">
                ...
                <p className="h1 text-primary mb-0 text-center">41,567</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="card">
            ...
            <div className="p-3 p-lg-4 card-body">
              <div className="mb-0 d-flex flex-row align-items-center justify-content-center gap-2 text-primary card-title h5">
                ...
                <p className="h1 text-primary mb-0 text-center">270.3K</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="card">
            ...
            <div className="p-3 p-lg-4 card-body">
              <div className="mb-0 d-flex flex-row align-items-center justify-content-center gap-2 text-primary card-title h5">
                ...
                <p className="h1 text-primary mb-0 text-center">894.6K</p>
              </div>
            </div>
          </div>
        </div>
